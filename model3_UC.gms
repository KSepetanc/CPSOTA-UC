...
equ(m3_3bin_MD)(t,k)$active_p_gen..              sum(h$(ord(h)>=ord(t)-MD(k)+1 and ord(h)<=ord(t)),z(h,k)) =l= 1 - x(t,k);
equ(m3_3bin_MU)(t,k)$active_p_gen..              sum(h$(ord(h)>=ord(t)-MU(k)+1 and ord(h)<=ord(t)),y(h,k)) =l= x(t,k);
